...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    elif query.data == "GetRefral":
        buttons = [
            [
                InlineKeyboardButton('Referral Link', url=f"https://telegram.me/{temp.U_NAME}?start=Ref-{query.from_user.id}"),
                InlineKeyboardButton('Forward This Message', switch_inline_query="Check out this bot! It offers great features!")
            ]
        ]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.REFERRAL_TXT.format(REFERAL_COUNT, REFERAL_PREMEIUM_TIME, temp.U_NAME, query.from_user.id,REFERAL_COUNT),
            parse_mode=enums.ParseMode.HTML
        )
        # await client.send_message(
        #     chat_id=query.from_user.id,
        #     text="<b>Broo Check This Bot Out ❕</b>\n\n"
        #         "➣ Search Movies & Series 🎬\n"
        #         "➣ Download Telegram Files 📂\n"
        #         "➣ High-Speed Streaming ⚡\n"
        #         "➣ Get New Movies First 🎞️\n\n"
        #         "Click below to start:",
        #     reply_markup=InlineKeyboardMarkup([
        #         [InlineKeyboardButton('🔗 Bot Link', url=f"https://telegram.me/{temp.U_NAME}")]
        #     ]),
        #     parse_mode=enums.ParseMode.HTML
        # )    
