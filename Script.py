...
ʙᴜʏ ᴘᴀɪᴅ ᴘʟᴀɴ ʙʏ - /plan</b>"""
    ...
    REFERRAL_TXT = """<b>🎉 ʀᴇғᴇʀ & ɢᴇᴛ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴ ⭐❕</b>  
▬▬▬▬▬▬▬▬▬▬▬▬▬  
🚹 <b>{}</b> Referral = <b>{}</b> Premium  
...
<b>How to refer:</b>  
1️⃣ Forward The Below Message 💬  
2️⃣ Share Your Referral Link With Friends 📩  
3️⃣ Get Premium When They Join❕  

<b>🔗 ʀᴇғᴇʀʀᴀʟ ʟɪɴᴋ:</b>  
https://telegram.me/{}?start=Ref-{}  

<b>🚀 ᴛɪᴘ:</b> Every {} unique user that starts the bot with your referral link will automatically add you to the premium list!  

💬 Got questions? We’re here to help!  

<b>🔥 ᴜᴘɢʀᴀᴅᴇ ɴᴏᴡ ᴛᴏ ᴘʀᴇᴍɪᴜᴍ:</b>  
👉 <b>Click /plan to Buy Paid Plan!</b> 👈  
▬▬▬▬▬▬▬▬▬▬▬▬▬  !"""
